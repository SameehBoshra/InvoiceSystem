                ...
                <form action="/Search_customers" method="POST" role="search" autocomplete="off">
                    ...
                    <div class="row">
                        ...
                        <div class="col">
                            ...
                            <select name="Department" class="form-control select2" onclick="console.log($(this).val())"
                            ...
                            <tbody>
                                ...
                                @foreach ($invoices as $invoice)
                                    ...
                                    <tr>
                                        ...
                                        <td><a
                                                href="{{ url('InvoicesDetails') }}/{{ $invoice->id }}">{{ $invoice->department->department_name }}</a>
                                        </td>
