		...
		<aside class="app-sidebar sidebar-scroll">
			<div class="main-sidebar-header active">
                <div class="logo-container" style="display: flex; align-items: center; gap: 10px;">
                    <img src="{{ URL::asset('assets/logoforme.png') }}" class="main-logo" alt="logo" style="height: 40px;">
                    <span style="font-size: 20px; font-weight: bold; color: #333;">فواتير</span>
                </div>
				<a class="desktop-logo logo-dark active" href="{{ url('/' . $page='index') }}"><img src="{{URL::asset('assets/img/brand/logo-white.png')}}" class="main-logo dark-theme" alt="logo"></a>
				<a class="logo-icon mobile-logo icon-light active" href="{{ url('/' . $page='index') }}"><img src="{{URL::asset('assets/logoforme.png')}}" class="logo-icon" alt="logo"></a>
			...
			<div class="main-sidemenu">
				<div class="app-sidebar__user clearfix">
					<div class="dropdown user-pro-body">
						<div class="">
							<img alt="user-img" class="avatar avatar-xl brround" src="{{URL::asset('assets/user.jpg')}}"><span class="avatar-status profile-status bg-green"></span>
						</div>
						<div class="user-info">
				...
				<ul class="side-menu">
					...
					<li class="slide">
						...
						<ul class="slide-menu">
                            ...
                            @can('الفواتير الغير مدفوعة')
                             ...
                             <li><a class="slide-item" href="{{ url('/' . $page='invoicesPartial') }}">الفواتير المدفوعة جزئيا</a></li>
                             @endcan
                             @can('ارشيف الفواتير')
                             <li><a class="slide-item" href="{{ url('/' . $page='invoicesDeleted') }}"> اﻷرشيف</a></li>
                             @endcan
						</ul>
					</li>
                    @endcan
					...
					<li class="slide">
						...
						<ul class="slide-menu">
                            ...
                            @endcan
                            @can('تقرير العملاء')
                            <li><a class="slide-item" href="{{ url('/' . $page='invoices_customers') }}">تقارير العملاء</a></li>
                            @endcan
						</ul>
					</li>
                    @endcan
					...
					<li class="slide">
						...
						<ul class="slide-menu">
                            @can('الاقسام')
							<li><a class="slide-item" href="{{ url('/' . $page='departments') }}"> اﻷقسام</a></li>
							@endcan
                            @can('المنتجات')
